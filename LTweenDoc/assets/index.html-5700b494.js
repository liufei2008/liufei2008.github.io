import{_ as e,a as n,b as i,c as a,d as t}from"./Functions-2a340b3b.js";import{_ as s,o as r,c as d,a as l}from"./app-0bcdde74.js";const c={},o=l(`<h1 id="ltweenersequence-动画序列" tabindex="-1"><a class="header-anchor" href="#ltweenersequence-动画序列" aria-hidden="true">#</a> LTweenerSequence（动画序列）</h1><p>LTweenerSequence是一种特殊的补间动画类型，它可以控制一组其他补间动画。首先，它是个补间动画，所以它继承了一般补间动画都有的属性和函数。它也有它自己独特的属性和函数。</p><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>/**
